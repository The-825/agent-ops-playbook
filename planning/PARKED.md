...
| Item | Why parked |
|---|---|
| Grant-aware wiring of the merge-gate decision script (the Phase 2 machine fields `grant_type` / `applies_to` / `paths` / `until` honored at merge time; the contract is documented in [docs/authority-ledger.md](../docs/authority-ledger.md), merged in #27) | Needs edits to existing kit files owned elsewhere today; natural next PR |
