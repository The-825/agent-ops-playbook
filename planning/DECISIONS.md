...
## D-9 · 2026-07-23 · The airport model essay and the reframed build story
Ruling: The public repo gains `docs/the-airport-model.md`, a storytelling essay that grows Book 1's dataset-wayfinding idea into the operating-model metaphor (one warehouse is a signed terminal; an institution is the airport, with a control tower, security, ground crews, wayfinding, and a flight log) and maps each part to a code shape already in this repo, positioned as the bridge to Book 2 (The Architect's Operating Model). The launch build story (`how-this-was-built.md`) is reframed to foreground the years of running the production system and to state authorship plainly: every decision, fact, and word is Jovan's, owned and his to answer for, the sessions did the labor. The campus descriptor is aligned to "a public research university in California" (book-side D-52) in `how-this-was-built.md` and the site book page.
Why: Jovan asked for an airport storytelling component as the conceptual home of Book 2 reflected in code, and for the public repo to match this session's reframed positioning (years of substance over a four-day build, full ownership) and the anonymized campus descriptor.
Source: Jovan, session 2026-07-23.
