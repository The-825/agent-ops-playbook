...
| [commands/](commands/README.md) | Twenty-one copy-paste slash-command definitions for Claude Code, each a markdown file with frontmatter; its README carries the install steps and the full table |
