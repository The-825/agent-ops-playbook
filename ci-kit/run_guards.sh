#!/usr/bin/env bash
# Run every CI lint guard over the repo (default paths). Exit non-zero if any
# guard fails. This is the aggregate gate your checks workflow calls. The guard
# registry lives in the GUARDS array below, not scattered across workflow YAML.
#
